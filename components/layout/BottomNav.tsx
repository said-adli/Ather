...
import { Home, BookOpen, ListChecks, User, Moon, Library } from "lucide-react";
        ...
        {NAV_ITEMS.map((item) => {
          ...
          return (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-col items-center justify-center w-12 h-full transition-all duration-300 ease-out",
            ...
            >
              ...
              <span 
                className={cn(
                  "text-[8px] mt-1 font-semibold transition-colors duration-300",

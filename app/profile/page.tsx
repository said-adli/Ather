  ...
  return (
    <div className="flex flex-col min-h-full safe-area-inset-top bg-slate-50/50">
      ...
      <header className="px-6 pt-10 pb-6 bg-white/80 backdrop-blur-xl border-b border-slate-100 sticky top-0 z-10 shadow-sm">
        <h1 className="text-3xl font-bold text-slate-800 tracking-tight">الملف الشخصي</h1>
        <p className="text-slate-500 font-medium mt-1">الإعدادات والتفضيلات</p>
      </header>
      ...
      <div className="flex-1 px-4 py-6 space-y-6">
        ...
        <section className="bg-white rounded-3xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-100">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-lg font-bold text-slate-800">
                {mounted && userName ? userName : "مستخدم أثر"}
              </h2>
              <p className="text-xs text-slate-400 font-medium tracking-wider">ملف محلي</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="bg-slate-50 rounded-2xl p-3 text-center border border-slate-100/50">
              <span className="text-xs text-slate-400 font-bold tracking-wider block mb-1">العادات</span>
              <span className="text-lg font-black text-emerald-600">{dailyProgress}%</span>
            </div>
            <div className="bg-slate-50 rounded-2xl p-3 text-center border border-slate-100/50">
              <span className="text-xs text-slate-400 font-bold tracking-wider block mb-1">الختمة</span>
              <span className="text-lg font-black text-emerald-600">{mounted ? khatmaProgress : 0}%</span>
            </div>
            <div className="bg-slate-50 rounded-2xl p-3 text-center border border-slate-100/50">
              <span className="text-xs text-slate-400 font-bold tracking-wider block mb-1">الآيات</span>
        ...
        <section className="bg-white rounded-3xl overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-100">
          <div className="px-6 pt-5 pb-3">
            <h2 className="text-sm font-bold text-slate-400 tracking-wider">الإعدادات</h2>
          </div>
          ...
          <div className="px-6 py-4 flex items-center justify-between border-b border-slate-50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-700">الاسم</p>
                <p className="text-xs text-slate-400">يظهر في الصفحة الرئيسية</p>
              </div>
            </div>
            <input
              ...
              placeholder="اسمك"
              className="w-28 text-left text-sm font-medium text-slate-600 bg-transparent border-none outline-none placeholder:text-slate-300 focus:ring-0"
              dir="rtl"
            />
          </div>
          ...
          <div className="px-6 py-4 flex items-center justify-between border-b border-slate-50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-700">حجم خط القرآن</p>
                <p className="text-xs text-slate-400">ضبط نص القارئ</p>
              </div>
            </div>
        ...
        <section className="bg-white rounded-3xl overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-slate-100">
          ...
          <div className="px-6 py-4 flex items-center justify-between">
            <p className="text-sm text-slate-500">جميع البيانات مخزنة محلياً على جهازك. لا يتم إرسال أي شيء إلى أي خادم.</p>
          </div>
        </section>
        ...
        <section className="bg-white rounded-3xl overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-red-100/50">
          <div className="px-6 pt-5 pb-3">
            <h2 className="text-sm font-bold text-red-400 tracking-wider">منطقة الخطر</h2>
          </div>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-right">
                  <p className="text-sm font-bold text-red-700">إعادة تعيين كل التقدم</p>
                  <p className="text-xs text-red-400">يمسح الختمة والعادات وجميع بيانات التتبع</p>
                </div>
              </div>
          ...
          >
            ...
            >
              <div className="flex flex-col items-center text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-slate-800 mb-2">إعادة تعيين كل التقدم؟</h3>
                <p className="text-sm text-slate-500 max-w-[280px]">
                  سيؤدي هذا إلى مسح تقدم الختمة وسجل العادات وجميع بيانات التتبع نهائياً. لا يمكن التراجع.
                </p>
              </div>
